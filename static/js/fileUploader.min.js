    ...
    var d = {
        ...
        initUploader: function(b) {
            ...
            var x = {
                ...
                server: p.options.isWechat ? "./index.php?c=utility&a=wechat_file&do=upload": "./index.php?c=utility&a=file&do=upload&type=" + b,
                compress: o,
                accept: k,
                fileNumLimit: l,
                fileSizeLimit: n,
        ...
        localPage: function(c) {
            ...
            g = "./index.php?c=utility&a=file&do=image&local=local",
            h = {
                page: c,
                year: i,
                month: j
        ...
        localVideoPage: function(c) {
            ...
            else var f = "./index.php?c=utility&a=file&do=local&type=video&pagesize=5",
            g = {
                page: c
            };
            ...
            h.find(".modal-footer .btn-primary").unbind("click").click(function() {
                ...
                h.find(".history-content .btn-primary").each(function() {
                    b.push(d.modalobj.find("#history_video").data("attachment")[a(this).attr("attachid")]),
                    a(this).removeClass("btn-primary")
                }),
                d.finish(b)
            }),
