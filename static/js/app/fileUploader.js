        ...
        function(a, b, c) {
            var d = {
                ...
                initUploader: function(b) {
                    ...
                    var q = a("#uploader"),
                        r = a('<ul class="filelist"><li class="fileinput-button js-add-image" id="filePicker2" style="display:none;"> <a href="javascript:;" class="fileinput-button-icon">+</a></li></ul>').appendTo(q.find(".queueList")),
                        s = q.find(".statusBar"),
                        t = s.find(".info"),
                        u = q.find(".uploadBtn"),
                    ...
                    var x = {
                        ...
                        server: p.options.isWechat ? "./index.php?c=utility&a=wechat_file&do=upload": this.url + b,
                        compress: o,
                        accept: k,
                        fileNumLimit: l,
                        fileSizeLimit: n,
                ...
                localPage: function(c) {
                    ...
                    if (d.options.isWechat) var e = d.options.type,
                        ...
                        g = "./index.php?c=utility&a=file&do=image&local=local&groupid=-999",
                        h = {
                            page: c,
                            year: i,
                            month: j,
