(function(window) {
	...
	util.clip = function(elm, str) {
		...
		require(['jquery.zclip'], function(){
			$(elm).zclip({
				path: '/static/resource/components/zclip/ZeroClipboard.swf',
				copy: str,
				afterCopy: function(){
    ...
    util.editor = function(e, t, o) {
        ...
        $.isFunction(t) && (t = {
            ...
            t = $.extend({},
                a, t),
            window.UEDITOR_HOME_URL = window.sysinfo.siteroot + "/static/resource/components/ueditor/";
        var r = function(a, r) {
            var l = {
                ...
                function(e, t) {
                    e.registerCommand(t, {
                        execCommand: function() {
                            r.fetch_url('/admin/system/upload/fetch');
                            r.upload_url('/admin/system/upload/upload?upload_type=');
                            r.image_url('/admin/system/upload/image?local=local&groupid=-999');
                            r.delet_url('/admin/system/upload/delete');
                            r.video_url('/admin/system/upload/video?local=local&type=video&pagesize=5');
                            r.show(function(t) {
