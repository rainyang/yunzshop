...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <div class='input-group'>
            ...
            <input type="text" name="widgets[sale][max_point_deduct]"  value="{php echo $item->max_point_deduct}" class="form-control" />
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <div class='input-group'>
            <span class="input-group-addon">最多抵扣</span>
            <input type="text" name="widgets[sale][max_balance_deduct]"  value="{php echo $item->max_balance_deduct}" class="form-control" />
            <span class="input-group-addon">元</span>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <div class='input-group'>
            ...
            <input type="text" name="widgets[sale][ed_num]"  value="{php echo $item->ed_num}" class="form-control" />
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <div class='input-group'>
            <span class="input-group-addon">满</span>
            <input type="text" name="widgets[sale][ed_money]"  value="{php echo $item->ed_money}" class="form-control" />
            <span class="input-group-addon">元</span>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <div id="areas" class="form-control-static">{php echo $item->ed_areas}</div>
        <a href="javascript:;" class="btn btn-default selectareas" onclick="selectAreas()" >添加不参加满包邮的地区</a>
        <input type="hidden" id='selectedareas' name="widgets[sale][ed_areas]" value="{php echo $item->ed_areas}" />
        <span class="help-block">如果设置0或空，则不支持满件包邮</span>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <div class='input-group'>
            <input type="text" name="widgets[sale][point]"  value="{php echo $item->point}" class="form-control" />
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <div class='input-group'>
            <input type="text" name="widgets[sale][bonus]"  value="{php echo $item->bonus}" class="form-control" />
            <span class="input-group-addon">元</span>
        </div>
