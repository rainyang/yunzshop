...
<div class="w1200 m0a">
            ...
            <div class='panel panel-default'>
                <div class='panel-body'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type='hidden' id='goodsid' name='comment[goods_id]' value="{php echo $comment->goods_id}" />
                            <div class='input-group'>
                                ...
                                <div class='input-group-btn'>
                                    ...
                                    <button class="btn btn-danger" type="button" onclick="$('#goodsid').val('');$('#goods').val('');">清除选择</button>
                                </div>
                            </div>
                            <span id="goodsthumb" class='help-block' {if empty($goods)} style="display:none" {/if} ><img  style="width:100px;height:100px;border:1px solid #ccc;padding:1px" src="{php echo isset($goods['thumb']) ? tomedia($goods['thumb']) : ''}"/></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            {php echo app\common\helpers\ImageHelper::tplFormFieldImage('comment[head_img_url]',$comment->head_img_url)}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <input type='text' class='form-control' name='comment[nick_name]' value='{php echo $comment->nick_name}' />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <input value="{php echo intval($comment->level)}" type="number" name='comment[level]'  id="level" class="rating" min=0 max=5 step=1 data-size="xs" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <textarea name='comment[content]' id="content" class="form-control">{php echo $comment->content}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                        <div class="col-sm-9 col-xs-12">
                            {php echo app\common\helpers\ImageHelper::tplFormFieldMultiImage('comment[images]',iunserializer($comment->images))}
                        </div>
                    </div>
    ...
    <script language='javascript'>
        ...
        function search_goods() {
            ...
            $.get('{php echo $this->createWebUrl('goods.goods.get-search-goods')}', {
