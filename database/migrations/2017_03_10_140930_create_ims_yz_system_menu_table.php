...
class CreateImsYzSystemMenuTable extends Migration {
	...
	public function up()
	{
		Schema::create('yz_system_menu', function(Blueprint $table)
		{
			...
			$table->integer('deleted_at')->unsigned()->comment('删除时间');
		});
	}
	...
	{
		Schema::drop('ims_yz_system_menu');
	}
