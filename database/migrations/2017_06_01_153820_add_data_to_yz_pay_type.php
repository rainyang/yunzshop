...
class AddDataToYzPayType extends Migration
{
    ...
    private function syncData()
    {
        ...
        \app\common\models\PayType::insert([
                ['id'=>0, 'name'=>'未支付', 'code'=>'unPay', 'type'=>0, 'plugin_id'=>0, 'unit'=>''],
                ['id'=>1, 'name'=>'微信支付', 'code'=>'wechatPay', 'type'=>2, 'plugin_id'=>0, 'unit'=>'元'],
                ['id'=>2, 'name'=>'支付宝支付', 'code'=>'alipay', 'type'=>2, 'plugin_id'=>0, 'unit'=>'元'],
                ['id'=>3, 'name'=>'余额支付', 'code'=>'balance', 'type'=>1, 'plugin_id'=>0, 'unit'=>'元'],
                ['id'=>4, 'name'=>'金币支付', 'code'=>'gold', 'type'=>1, 'plugin_id'=>0, 'unit'=>'金币']]
        );
