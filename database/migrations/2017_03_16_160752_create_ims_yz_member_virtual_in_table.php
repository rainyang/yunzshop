...
class CreateImsYzMemberVirtualInTable extends Migration {
	...
	public function up()
	{
		Schema::create('yz_member_virtual_in', function(Blueprint $table)
		{
	...
	{
		Schema::drop('ims_yz_member_virtual_in');
	}
