...
class PreOrder extends Order
{
    ...
    protected function initAttributes()
    {
        $attributes = array(
            ...
            'invoice_type'=>$this->getParams('invoice_type'),//发票类型
            'rise_type'=>$this->getParams('rise_type'),//收件人或单位
            'call'=>$this->getParams('call'),//抬头或单位名称
            'company_number'=>$this->getParams('company_number'),//单位识别号
        );
