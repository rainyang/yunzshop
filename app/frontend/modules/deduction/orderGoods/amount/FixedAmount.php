...
class FixedAmount extends OrderGoodsDeductionAmount
{
    ...
    public function getMaxAmount()
    {
        ...
        $result = min($result,$this->getOrderGoods()->getPriceBefore($this->getGoodsDeduction()->getCode().'RestDeduction'));
        return max($result, 0);
    }
    ...
    public function getMinAmount()
    {
        ...
        $result = min($result,$this->getOrderGoods()->getPriceBefore($this->getGoodsDeduction()->getCode().'MinDeduction'));
