...
//                $order_total += $order->sum();
    ...
    public static function userData_v2($member_info, $yz_member)
    {
        ...
        //增加是否显示爱心值值
        $member_info['love_show'] = [
            'usable_love_show' => \Setting::get('love.member_center_usable_show') ? 1 : 0,
        ...
        if (app('plugins')->isEnabled('love')) {
            $memberLove = MemberLove::where('member_id', \YunShop::app()->getMemberId())->first();
            $member_info['love_show']['usable_text'] = \Yunshop\Love\Common\Services\SetService::getLoveSet('usable_name') ?: '红爱心值';
            $member_info['love_show']['usable_data'] = $memberLove->usable ?: '0.00';
            $member_info['love_show']['unable_text'] = \Yunshop\Love\Common\Services\SetService::getLoveSet('unable_name') ?: '白爱心值';
