...
class YzMemberAddress extends \app\common\models\YzMemberAddress
{
    protected $guarded = [''];
    /*
    ...
    {
        return static::select('id', 'username', 'mobile', 'zipcode', 'province', 'city', 'district','street', 'address', 'isdefault')
