...
if($operation == 'display' && $_W['isajax']){
    ...
    $total = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename('sz_yi_order') . ' o left join '.tablename('sz_yi_cashier_order').' co on o.id = co.order_id '.' where 1 and o.cashier = 1  and '.$condition, $params);
