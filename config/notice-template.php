...
return [
    ...
    'member_agent' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword2",
                "value" => "尊敬的[会员昵称]，您于[时间]获得推广资格，赶紧去呼唤小伙伴吧。",
                "color" => "#000000",
            ],
        ],
        'remark' => '感谢您的支持。',
    ...
    'member_new_lower' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword2",
                "value" => "尊敬的[会员昵称]，您于[时间]新增粉丝[下级会员昵称]。",
                "color" => "#000000",
            ],
        ],
        'remark' => '感谢您的支持。',
    ...
    'commission_upgrade' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，恭喜您于[时间]由[旧等级]升级为[新等级]，一级分销比例由[旧一级分销比例]升为[新一级分销比较]，二级分销比例由[旧二级分销比例]升为[新二级分销比较]，三级分销比例由[旧三分销比例]升为[新三级分销比较]",
                "color" => "#000000",
            ],
        ],
        'remark' => '继续加油哦！',
    ...
    'statement' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，您有一笔奖励于[结算时间]结算了，结算金额为[佣金金额]。",
                "color" => "#000000",
            ],
        ],
        'remark' => '继续加油哦！',
    ...
    'area_dividend' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "亲爱的[昵称]，您于[时间]获得一笔[等级]区域分红，分红金额为[金额]",
                "color" => "#000000",
            ],
        ],
    ...
    'return' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，您于[时间]获得返现金额[返现金额]，商城销售额为[商城销售额]，您的返现比例为[返现比例]，所处经销商等级为[团队等级]，等级权益为[等级权益]，同等级团队人数为[同等级团队人数] ，总权益[总权益] ",
                "color" => "#000000",
            ],
        ],
        'remark' => '请继续加油！',
    ...
    'team_dividend' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，您于[时间]有一笔奖励结算了！订单金额：[订单金额]，分红结算金额：[经销结算金额]，分红奖励金额：[提成金额]",
                "color" => "#000000",
            ],
        ],
        'remark' => '请继续加油！',
    ...
    'flat_prize' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "亲爱的[昵称]，您于[时间]获得一笔平级奖！订单金额：[订单金额]，奖励结算金额：[提成结算金额]，平级奖金额：[平级奖金额]",
                "color" => "#000000",
            ],
        ],
        'remark' => '请继续加油！',
    ...
    'shareholder_dividend' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，您于[时间]有一笔[代理等级]股东分红发放了！分红金额：[分红金额]。",
                "color" => "#000000",
            ],
        ],
        'remark' => '请继续加油！',
    ...
    'merchant_center_order_bonus' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，您的[供应商昵称]产生一笔新的订单了！订单金额：[订单金额]，分红比例为：[分红比例]，下级分红比例为：[下级分红比例]，会员确认收货后您将获得分红[分红金额]元。",
                "color" => "#000000",
            ],
        ],
        'remark' => '感谢您的支持！',
    ...
    'merchant_staff_order_bonus' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，您的[供应商昵称]产生一笔新的订单了！订单金额：[订单金额]，分红比例为：[分红比例]，会员确认收货后您将获得分红[分红金额]元。",
                "color" => "#000000",
            ],
        ],
        'remark' => '感谢您的支持！',
    ...
    'merchant_center_order_bonus_settlement' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，您于[时间]有一笔招商中心分红结算了！供应商[供应商昵称]，订单金额：[订单金额]，分红结算金额：[分红结算金额]，分红奖励金额：[分红金额]",
                "color" => "#000000",
            ],
        ],
        'remark' => '请继续加油！',
    ...
    'merchant_staff_order_bonus_settlement' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，您于[时间]有一笔招商员分红结算了！供应商[供应商昵称]，订单金额：[订单金额]，分红结算金额：[分红结算金额]，分红奖励金额：[分红金额]",
                "color" => "#000000",
            ],
        ],
        'remark' => '请继续加油！',
    ...
    'micro_bonus_settlement' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，尊敬的[昵称]，您于[时间]有一笔分红结算了！分红金额为[分红金额]",
                "color" => "#000000",
            ],
        ],
        'remark' => '请继续加油！',
    ...
    'supplier_withdraw_apply' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]您于[申请时间]申请的[提现金额]，提现单号为[提现单号]",
                "color" => "#000000",
            ],
        ],
        'remark' => '这边将尽快为您审核！',
    ...
    'supplier_withdraw_pass' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]您申请的[提现金额]，提现单号为[提现单号]，已于[审核时间]审核通过！",
                "color" => "#000000",
            ],
        ],
        'remark' => '这边将尽快为您打款！',
    ...
    'supplier_withdraw_reject' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]您申请的[提现金额]审核不通过，已于[驳回时间]被驳回！",
                "color" => "#000000",
            ],
        ],
        'remark' => '请再次提交申请或联系客服！',
    ...
    'supplier_withdraw_play' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]您申请的[提现金额]，已于[打款时间]打款成功！",
                "color" => "#000000",
            ],
        ],
        'remark' => '请注意查收！',
    ...
    'change_temp_id' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[会员昵称]，您于[时间]发生一笔爱心值变动，变动类型为[变动类型]，变动数值为[变动数量]，变动后爱心值余值为[当前剩余值]。",
                "color" => "#000000",
            ],
        ],
        'remark' => '感谢您的支持！',
    ...
    'activation_temp_id' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[会员昵称]，您于[时间]激活了一笔爱心值，激活数值为[激活值]",
                "color" => "#000000",
            ],
        ],
        'remark' => '感谢您的支持！',
    ...
    'expire' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "亲爱的自然港会员，您有一张优惠券即将过期，请及时使用哦！优惠券名称：[优惠券名称]，使用范围：[优惠券使用范围]，过期时间：[过期时间]",
                "color" => "#000000",
            ],
        ],
        'remark' => '请及时使用哦！',
    ...
    'coupon_notice' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "亲爱的[昵称]，您获得了一张优惠券[优惠券名称]，优惠券使用方式[优惠券使用方式],优惠券使用范围[优惠券使用范围]，优惠条件[优惠条件]，于[过期时间]过期。",
                "color" => "#000000",
            ],
        ],
        'remark' => '请及时使用哦！',
