...
return [
    ...
    'other_toggle_temp' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的用户，您的[下级层级]会员[下级昵称]下单购买了商品，订单编号：[订单号]，订单金额：[订单金额]，订单状态为：[订单状态]",
                "color" => "#000000",
            ],
        ],
        'remark' => '请继续加油！',
    ...
    'commission_upgrade' => [
        ...
        'data' => [
            ...
            2 => [
                "keywords" => "keyword3",
                "value" => "尊敬的[昵称]，恭喜您于[时间]由[旧等级]升级为[新等级]，一级分销比例由[旧一级分销比例]%升为[新一级分销比例]%，二级分销比例由[旧二级分销比例]%升为[新二级分销比例]%，三级分销比例由[旧三分销比例]%升为[新三级分销比例]%",
                "color" => "#000000",
            ],
        ],
        'remark' => '继续加油哦！',
