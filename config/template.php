 ...
 */
    ...
    'param' => [
        '销售平台名称', '供应商平台名称','订单号','下单时间','订单金额','商品详情（含规格）'
        ]
    ],
 ...
 */
    ...
    'param' => [
        '销售平台名称', '供应商平台名称','订单号','下单时间','订单金额','商品详情（含规格）','支付时间'
        ]
    ],
 ...
 */
    ...
    'param' => [
        '销售平台名称', '供应商平台名称','粉丝昵称','订单号','下单时间','订单金额','商品详情（含规格）','发货时间','快递公司','快递单号'
,        ]
    ],
 ...
 */
    ...
    'param' => [
        '销售平台名称', '供应商平台名称','粉丝昵称','订单号','下单时间','订单金额','商品详情（含规格）','确认收货时间'
        ]
    ],
 ...
 */
    ...
    'param' => [
        '主平台名称', '粉丝昵称','订单号','下单时间','订单金额','商品详情（含规格）'
        ]
    ],
 ...
 */
    ...
    'param' => [
        '主平台名称','粉丝昵称','订单号','下单时间','订单金额','商品详情（含规格）','支付时间'
        ]
    ],
 ...
 */
    ...
    'param' => [
        '主平台名称', '粉丝昵称','订单号','下单时间','订单金额','运费','商品详情（含规格）','发货时间','快递公司','快递单号'
        ]
    ],
 ...
 */
    ...
    'param' => [
        '主平台名称', '粉丝昵称','订单号','下单时间', '订单金额','商品详情（含规格）','确认收货时间'
        ]
    ],
