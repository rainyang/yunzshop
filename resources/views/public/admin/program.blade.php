    ...
    data(){
        return{
          ...
          member:[
            ...
            {"name":"我的收藏","href":"/pages/member/collection/collection"},
            {"name":"我的足迹","href":"/pages/member/footprint/footprint"},
            {"name":"会员充值","href":"/packageA/member/balance/balance/balance"},
            {"name":"收货地址","href":"/pages/member/addressList/addressList"},
          ],
          webapp:[
            {"name":"会员信息","href":"/packageA/member/info/info"},
            {"name":"修改手机","href":"/packageA/member/editmobile/editmobile"},
            {"name":"会员余额","href":"/pages/member/balance/balance"},
            ...
            {"name":"收货地址","href":"/pages/member/addressList/addressList"},
            {"name":"添加收货地址","href":"/pages/member/addressAdd_v2/addressAdd_v2"},
            {"name":"未提现分销佣金","href":"/packageA/member/extension/notPresent/notPresent"},
            {"name":"我的足记","href":"/pages/member/footprint/footprint"},
            {"name":"我的收藏","href":"/pages/member/collection/collection"},
            {"name":"我的关系","href":"/pages/member/myRelationship/myRelationship"},
            {"name":"我的评价","href":"/pages/member/myRelationship/myRelationship"},
            ...
            {"name":"售后列表","href":"/pages/member/myOrder/Aftersaleslist/Aftersaleslist"},
            {"name":"优惠券","href":"/packageA/member/coupon_v2/coupon_v2"},
            {"name":"领券中心","href":"/pages/coupon/coupon_store"},
