            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group refund-group" style="display: none;">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                            <textarea class="form-control" name="message">{{$order['has_one_refund_apply']['message']}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group express-group" @if($order['has_one_refund_apply']['status'] != 5)style="display: none;" @endif>
                    ...
                    <div class="form-group express-group" @if($order['has_one_refund_apply']['status'] < 5)style="display: none;" @endif>
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                            <input type="text" name="rexpresssn" class="form-control" value="{$order['has_one_refund_apply']['rexpresssn']}"/>
                        </div>
                    </div>
