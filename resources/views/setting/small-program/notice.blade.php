                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-xs-12">
                                <select name='yz_notice[point_change]' class='form-control diy-notice'>
                                    <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['point_change'])) value="{{$set['point_change']}}"
                                    selected @else value=""
                                            @endif
                                    >
                                        默认消息模板
                            ...
                            {{--<div class="col-sm-2 col-xs-6">--}}
                                {{--<input class="mui-switch mui-switch-animbg" id="point_change" type="checkbox"--}}
                                       {{--@if(\app\common\models\notice\MinAppTemplateMessage::getOpenTemp($set['point_change']))--}}
                                       {{--checked--}}
                                       {{--@endif--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-xs-12">
                                <select name='yz_notice[balance_change]' class='form-control diy-notice'>
                                    <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['balance_change'])) value="{{$set['balance_change']}}"
                                            selected @else value=""
                                            @endif
                                    >
                                        默认消息模版
                            ...
                            {{--<div class="col-sm-2 col-xs-6">--}}
                                {{--<input class="mui-switch mui-switch-animbg" id="balance_change" type="checkbox"--}}
                                       {{--@if(\app\common\models\notice\MinAppTemplateMessage::getOpenTemp($set['balance_change']))--}}
                                       {{--checked--}}
                                       {{--@endif--}}
                                       {{--onclick="message_default(this.id)"/>--}}
                            {{--</div>--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-xs-12">
                                <select name='yz_notice[buy_goods_msg]' class='form-control diy-notice'>
                                    <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['buy_goods_msg'])) value="{{$set['buy_goods_msg']}}"
                                            selected @else value=""
                                            @endif
                                    >
                                        默认消息模板
                            ...
                            {{--<div class="col-sm-2 col-xs-6">--}}
                                {{--<input class="mui-switch mui-switch-animbg" id="buy_goods_msg" type="checkbox"--}}
                                       {{--@if(\app\common\models\notice\MinAppTemplateMessage::getOpenTemp($set['buy_goods_msg']))--}}
                                       {{--checked--}}
                                       {{--@endif--}}
                                       {{--onclick="message_default(this.id)"/>--}}
                            {{--</div>--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 col-xs-12">
                                <select name='yz_notice[other_toggle_temp]' class='form-control diy-notice'>
                                    <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['other_toggle_temp'])) value="{{$set['other_toggle_temp']}}"
                                            selected @else value=""
                                            @endif
                                    >
                                        默认消息模板
                            ...
                            {{--<div class="col-sm-2 col-xs-6">--}}
                                {{--<input class="mui-switch mui-switch-animbg" id="other_toggle_temp" type="checkbox"--}}
                                       {{--@if(\app\common\models\notice\MinAppTemplateMessage::getOpenTemp($set['other_toggle_temp']))--}}
                                       {{--checked--}}
                                       {{--@endif--}}
                                       {{--onclick="message_default(this.id)"/>--}}
                            {{--</div>--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-xs-12">
                                    <select name='yz_notice[customer_upgrade]' class='form-control diy-notice'>
                                        <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['customer_upgrade'])) value="{{$set['customer_upgrade']}}"
                                                selected @else value=""
                                                @endif
                                        >
                                            默认消息模板
                                ...
                                {{--<div class="col-sm-2 col-xs-6">--}}
                                    {{--<input class="mui-switch mui-switch-animbg" id="customer_upgrade" type="checkbox"--}}
                                           {{--@if(\app\common\models\notice\MinAppTemplateMessage::getOpenTemp($set['customer_upgrade']))--}}
                                           {{--checked--}}
                                           {{--@endif--}}
                                           {{--onclick="message_default(this.id)"/>--}}
                                {{--</div>--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-xs-12">
                                    <select name='yz_notice[withdraw_submit]' class='form-control diy-notice'>
                                        <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['withdraw_submit'])) value="{{$set['withdraw_submit']}}"
                                                selected @else value=""
                                                @endif
                                        >
                                            默认消息模板
                                ...
                                {{--<div class="col-sm-2 col-xs-6">--}}
                                    {{--<input class="mui-switch mui-switch-animbg" id="withdraw_submit" type="checkbox"--}}
                                           {{--@if(\app\common\models\notice\MinAppTemplateMessage::getOpenTemp($set['withdraw_submit']))--}}
                                           {{--checked--}}
                                           {{--@endif--}}
                                           {{--onclick="message_default(this.id)"/>--}}
                                {{--</div>--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-xs-12">
                                    <select name='yz_notice[withdraw_success]' class='form-control diy-notice'>
                                        <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['withdraw_success'])) value="{{$set['withdraw_success']}}"
                                                selected @else value=""
                                                @endif
                                        >
                                            默认消息模板
                                ...
                                {{--<div class="col-sm-2 col-xs-6">--}}
                                    {{--<input class="mui-switch mui-switch-animbg" id="withdraw_success" type="checkbox"--}}
                                           {{--@if(\app\common\models\notice\MinAppTemplateMessage::getOpenTemp($set['withdraw_success']))--}}
                                           {{--checked--}}
                                           {{--@endif--}}
                                           {{--onclick="message_default(this.id)"/>--}}
                                {{--</div>--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 col-xs-12">
                                    <select name='yz_notice[withdraw_fail]' class='form-control diy-notice'>
                                        <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['withdraw_fail'])) value="{{$set['withdraw_fail']}}"
                                                selected @else value=""
                                                @endif
                                        >
                                            默认消息模板
                                ...
                                {{--<div class="col-sm-2 col-xs-6">--}}
                                    {{--<input class="mui-switch mui-switch-animbg" id="withdraw_fail" type="checkbox"--}}
                                           {{--@if(\app\common\models\notice\MinAppTemplateMessage::getOpenTemp($set['withdraw_fail']))--}}
                                           {{--checked--}}
                                           {{--@endif--}}
                                           {{--onclick="message_default(this.id)"/>--}}
                                {{--</div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-xs-12">
                                        <select name='yz_notice[withdraw_reject]' class='form-control diy-notice'>
                                            <option @if(\app\common\models\notice\MinAppTemplateMessage::getTemp($set['withdraw_reject'])) value="{{$set['withdraw_reject']}}"
                                                    selected @else value=""
                                                    @endif
                                            >
                                                默认消息模板
