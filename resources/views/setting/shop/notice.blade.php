                    ...
                    <div class='panel-body'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <label class='radio-inline'><input type='radio' name='notice[toggle]' value='1' @if ($set['toggle'] == 1) checked @endif/> 开启</label>
                                <label class='radio-inline'><input type='radio' name='notice[toggle]' value='0' @if (empty($set['toggle'])) checked @endif /> 关闭</label>
