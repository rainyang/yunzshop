                ...
                <div class="panel panel-default">
                    ...
                    <div class='panel-body'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="radio" name="notice[toggle]" class="form-control" value="1"
                                       @if (1 == $set['toggle']) checked @endif/> 开
                                <input type="radio" name="notice[toggle]" class="form-control" value="0"
                                       @if (0 == $set['toggle']) checked @endif/> 关
                    ...
                    <div class='panel-body'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" name="notice[carrier]" class="form-control"
                                       value="{{ $set['carrier'] }}"/>
