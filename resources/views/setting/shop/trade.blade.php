        ...
        <div class="panel panel-default">
            ...
            <div class='panel-body'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="">
                            <label class='radio-inline'><input type='radio' name='trade[refund_status]' select="selected" value='1' @if ($set['refund_status'] == 1) checked @endif/> 开启</label>
                            <label class='radio-inline'><input type='radio' name='trade[refund_status]' value='0' @if ($set['refund_status'] == 0) checked @endif /> 关闭</label>
                        </div>
