<div class="form-group key_item">
    ...
    <div class="col-sm-9" style="padding:0;padding-left:15px;">
        <input type="text" name="temp[tp_kw][]" class="form-control" value="{{$list2['keywords']}}{{$tpkw}}" placeholder="键名"/>
    </div>
</div>
...
<div class="form-group key_item">
    ...
    <div class="col-sm-7" style="padding:0;padding-left:15px;">
        <textarea name="temp[tp_value][]" class="form-control" placeholder="键值" rows="5">{{$list2['value']}}</textarea>
    </div>
    <div class="col-sm-1" style="padding:0">
        <input type="color" name="temp[tp_color][]" value="{{$list2['color']}}" style="width:32px;height:32px;"/>
    </div>
