                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12 control-label" style="text-align:left;">
                                @if (!empty($menu['parent_id'])) {{$menu['parent']['name']}}  @endif
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" name="menu[sort]" class="form-control" value="{{$menu['sort']}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" name="menu[item]" class="form-control" value="{{ $menu['item']}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" name="menu[url]" class="form-control" value="{{$menu['url']}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" name="menu[url_params]" class="form-control" value="{{$menu['url_params']}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <label class='radio-inline'>
                                    <input type='radio' name='menu[permit]' value='1' @if ($menu['permit'] == 1) checked @endif /> 是
                                </label>
                                <label class='radio-inline'>
                                    <input type='radio' name='menu[permit]' value='0' @if (empty($menu['permit']) || $menu['permit'] == 0 ) checked @endif/> 否
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <label class='radio-inline'>
                                    <input type='radio' name='menu[menu]' value='1' @if ($menu['menu'] == 1) checked @endif /> 是
                                </label>
                                <label class='radio-inline'>
                                    <input type='radio' name='menu[menu]' value='0' @if (empty($menu['menu']) || $menu['menu'] == 0 ) checked @endif/> 否
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    <label class='radio-inline'>
                                        <input type='radio' name='menu[status]' value='1' @if ($menu['status'] == 1) checked @endif /> 启用
                                    </label>
                                    <label class='radio-inline'>
                                        <input type='radio' name='menu[status]' value='0' @if (empty($menu['status']) || $menu['status'] == 0 ) checked @endif /> 禁止
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="hidden" name="menu[parent_id]" class="form-control" value="{{$menu['parent_id']}}" />
