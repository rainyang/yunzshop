                ...
                <div class="panel-body">
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" name="user[mobile]" id="displayorder" placeholder="请输入手机号" class="form-control" value="{{$user->mobile}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-xs-12">
                                <input type="text" name="user[endtime]" id="displayorder" placeholder="设置用户组有效期，为0则永久有效！" class="form-control" value="{{$user->endtime}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <textarea placeholder="可输入备注信息" rows="3" cols="20" name="user[remark]" class="form-control">{{$user->remark}}</textarea>
                            </div>
                        </div>
