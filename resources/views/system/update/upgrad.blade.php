...
@section('content')
    ...
    <script>
        ...
        $(function() {
            $.ajax({
                url: '/index.php/admin/system/update/verifyCheck',
                type: 'get',
                dataType: 'json',
                beforeSend: function(){
                ...
                if (-1 == ret.result) {
                    window.location.href = "/index.php/admin/system/update/pirate";
                }
            ...
            $("#updateVersion").click(function () {
                ...
                $btn.button('loading');
                $.ajax({
                    url: '/index.php/admin/system/update/startDownload',
        ...
        function upgrade(){
            ...
            $.ajax({
                url: '/index.php/admin/system/update/fileDownload',
                data:{'nofiles': fileIds, '_token':'{{csrf_token()}}'},
                //traditional :true,
                type:'post',
                dataType:'json',
