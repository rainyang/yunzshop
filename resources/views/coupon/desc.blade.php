...
<div class='panel-body'>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <label class="radio-inline" >
                <input type="radio" name="descnoset" value="0" @if($coupon['descnoset'] == 0)checked="true" @endif /> 使用
            </label>

            <label class="radio-inline">
                <input type="radio" name="descnoset" value="1" @if($coupon['descnoset'] == 1)checked="true" @endif /> 不使用
            </label>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            {!! app\common\helpers\UeditorHelper::tpl_ueditor('desc', $coupon['desc']) !!}
        </div>
    </div>
</div>
<div class='panel-heading'>
