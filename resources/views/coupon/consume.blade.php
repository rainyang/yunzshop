<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <label class="radio-inline" ><input type="radio" name="coupon_method" onclick='showbacktype(0)' value="1" @if($coupon['coupon_method']==0)checked @endif>立减</label>
        <label class="radio-inline"><input type="radio" name="coupon_method" onclick='showbacktype(1)' value="2" @if($coupon['coupon_method']==1)checked @endif>打折</label>
        {{--<label class="radio-inline "><input type="radio" name="coupon_method" onclick='showbacktype(2)' value="2" @if($coupon['coupon_method']==2)checked @endif>返利</label>--}}
    </div>
</div>
<div class="form-group">
    ...
    <div class='input-group'>
        ...
        <input type='text' class='form-control' name='deduct' value="{{$coupon['deduct']}}"/>
