<div class='panel-body'>
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <input type="text" name="resp_title" class="form-control" value="{{$coupon['resp_title']}}"  />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            {!! app\common\helpers\ImageHelper::tplFormFieldImage('resp_thumb', $coupon['resp_thumb']) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <textarea name="resp_desc" class='form-control'>{{$coupon['resp_desc']}}</textarea>
            <span class="help-block">变量 [nickname] 会员昵称 [total] 优惠券张数</span>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <input type="text" name="resp_url" class="form-control" value="{{$coupon['resp_url']}}"  />
