...
<div>
    ...
    <a class="btn btn-primary btn-sm disbut" href="javascript:;" onclick="send()"  data-toggle="modal"
...
<a class="btn btn-danger btn-sm disbut" href="javascript:;"
   onclick="$('#modal-confirmsend').find(':input[name=order_id]').val('{{$order['id']}}')" data-toggle="modal"
