                        ...
                        <table class='table order-title'>
                            <tr>
                                <td class="left" colspan='8'>
                                    ...
                                    @if( 0&&$order['rstatus'] == 4)<label
                                            class='label label-primary'>客户已经寄出快递</label>@endif
                                    @section('shop_name')
                                ...
                                @if(!empty($order['refund_data']))
                                        <label class="label label-info" style="background-color: #ef5555 !important;">
                                            {{$order['refund_data']['refund_type_name']}}
                                        </label>
                                @endif
                                <td class="right">
