    ...
    <div class="rightlist">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-lg-9">
                            <input class="form-control" name="search[keyword]" id="" type="text"
                                   value="{php echo $search['keyword']}" placeholder="商品标题">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-8 col-lg-9">
                            <select name='search[fade]' class='form-control'>
                                <option value='' {if $search['fade']==''}selected{/if}>全部</option>
                                <option value='2' {if $search['fade']=='2'}selected{/if}>模拟评价</option>
                                <option value='1' {if $search['fade']=='1'}selected{/if} >真实评价</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <select name='search[searchtime]' class='form-control'>
                                <option value='' {if empty($search['searchtime'])}selected{/if}>不搜索</option>
                                <option value='1' {if $search['searchtime']==1}selected{/if} >搜索</option>
                            </select>
                        </div>
                        <div class="col-sm-7 col-lg-7 col-xs-12">
                            {php echo app\common\helpers\DateRange::tplFormFieldDateRange('search[time]', ['starttime'=>date('Y-m-d H:i', $search['starttime']), 'endtime'=>date('Y-m-d H:i',$search['endtime'])], true);}
                        </div>
        ...
        <div class='panel panel-default'>
            ...
            <div class='panel-body'>
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><img src="{php echo tomedia($row['goods']['thumb'])}"
                                 style="width: 30px; height: 30px;border:1px solid #ccc;padding:1px;">
                            {$row['goods']['title']}
                        </td>
                        <td>
                            <img src="{php echo tomedia($row['head_img_url'])}"
                                 style="width: 30px; height: 30px;border:1px solid #ccc;padding:1px;">
                            {$row['nick_name']}
                        </td>
                        ...
                        <td>
                            <label class='label label-primary'>首次评论</label>
                        </td>
                        ...
                        <td>
                            ...
                            <a class='btn btn-default'
                               href="{php echo $this->createWebUrl('goods.comment.reply', ['id' => $row['id']])}"
                            ...
                            <a class='btn btn-default'
                               href="{php echo $this->createWebUrl('goods.comment.updated', ['id' => $row['id']])}"
                            ...
                            {ifp 'shop.comment.add'}
                            <a class='btn btn-default'
                               href="{php echo $this->createWebUrl('goods.comment.add-comment', ['goods_id' => $row['goods_id']])}"
                               title='添加此商品评价'><i class="fa fa-plus"></i>
                            </a>
                            {/if}
                            {ifp 'shop.comment.delete'}
                            <a class='btn btn-default'
                               href="{php echo $this->createWebUrl('goods.comment.deleted', ['id' => $row['id']])}"
            ...
            <div class='panel-footer'>
                <a class='btn btn-primary' href="{php echo $this->createWebUrl('goods.comment.add-comment')}"><i
