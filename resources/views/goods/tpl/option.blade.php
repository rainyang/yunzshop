...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <label class="checkbox-inline">
            <input type="checkbox" id="hasoption" value="1" name="goods[has_option]"
                   @if($goods['has_option']==1) checked @endif />启用{{$lang['shopoption']}}
        </label>
    ...
    <div class="col-sm-9 col-xs-12">
        <label class="checkbox-inline">
            <input type="checkbox" id="opt_switch" value="1" name="opt_switch"
                   @if( $goods['opt_switch']==1) checked @endif />启用规格模板
        </label>
