				...
				<div class="panel-body">
					<form  action="" method="post" class="form-horizontal" role="form">
						...
						<!--	<label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label"></label>-->
							<div class="">
								<input class="form-control" placeholder="请输入关键字" name="search[keyword]" id="keyword" type="text" value="{{$requestSearch['keyword']}}" onclick="value='';" ／>
							</div>
						</div>
						<div class="form-group col-xs-12 col-sm-8 col-lg-2">
					<!--		<label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">状态</label>-->
						...
						<div class='form-input col-xs-12 col-sm-8 col-lg-6'>
							...
							<input class="form-control price" name="search[min_price]" id="minprice" type="text" value="" onclick="value='';" ／>
							<p class="line">—</p>
							<input class="form-control price" name="search[max_price]" id="max_price" type="text" value="" onclick="value='';" ／>
						</div>
							...
							@foreach($list as $item)
								...
								<tr>
									...
									<td style="position:relative; overflow:visible;" width="20%">
										...
										<a href="{{yzWebUrl($delete_url, array('id' => $item['id']))}}" onclick="return confirm('{{$delete_msg}}');
