            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="17%">
                <el-form-item label="开启满额优惠">
                    ...
                    <!-- <el-tooltip :content="form.open?'已开启':'已关闭'" placement="top">
                        ...
                        <input type="radio" name='switch' value='close' v-model="form.open" style='margin-left:16px' checked {{ form.open ? '' : 'checked' }}  >关闭
                ...
                <el-form-item label="满额包邮">
                    ...
                    <input type="radio" name='freeSwitch' value='close' v-model="form.freeFreight.open"  style='margin-left:16px' checked {{ form.freeFreight.open ? '' : 'checked'}}   >关闭
