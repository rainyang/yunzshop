            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="17%">
                <el-form-item label="开启满额优惠">
                    ...
                    <!-- <el-tooltip :content="form.open?'已开启':'已关闭'" placement="top">
                        ...
                        <input type="radio" name='switch' v-model="form.open" value='1' >开启
                        <input type="radio" name='switch' value='0' v-model="form.open" style='margin-left:16px' >关闭
                ...
                <el-form-item label="满额包邮">
                    ...
                    <input type="radio" name='freeSwitch' v-model="form.freeFreight.open" value='1'  >开启
                    <input type="radio" name='freeSwitch' value='0' v-model="form.freeFreight.open"  style='margin-left:16px'  >关闭
