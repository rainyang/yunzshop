 ...
 * @version   v1.0
 */
namespace api\controller\commission;
...
class Apply extends \api\YZ
{
    ...
    public function __construct()
    {
        ...
        $this->commission_apply_model = new \api\model\commissionApply($para['uniacid']);
        $this->commission_model = new \api\model\commission();
