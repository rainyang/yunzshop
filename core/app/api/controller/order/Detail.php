...
class Detail extends YZ
{
    ...
    {
        //$result = ArrayHelper::;
        $address_block_list = $this->_getAddressBlockTypeId();//配送信息
        $button_list = $this->_getButtonList();//按钮列表
        $show_diyform = $this->_canShowDiyForm();//显示diyform
        $order_status_str = $this->_getStatusStr();//订单状态文字
        $res = array(
