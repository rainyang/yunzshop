...
}elseif($operation == 'assigns')
{
    if ($_W['isajax']) {
        $assigns_id = $_GPC['assigns_id'];
        ...
        if ($assigns) {
            ...
            $messages = array(
                'keyword1' => array('value' => '转增通知', 
                    'color' => '#73a68d'),
                    'keyword2' => array('value' => $member['nickname'].'向你转增金额'.$money."元！",
                                    'color' => '#73a68d'
                     )
                );
            ...
            $messages = array(
                'keyword1' => array('value' => '转增通知', 
                    'color' => '#73a68d'),
                    'keyword2' => array('value' => '你向'.$assigns['nickname'].'转增金额'.$money."元！",
                                    'color' => '#73a68d'
                     )
                );
