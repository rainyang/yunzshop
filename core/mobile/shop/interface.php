...
if ($operation == 'result') {
    ...
    $qiniu_domain = "http://odftzlvw9.bkt.clouddn.com/";

    $banner = pdo_fetch("SELECT * FROM " . tablename('sz_yi_banner') . " WHERE uniacid=:uniacid AND enabled=1 ORDER BY `id` DESC" ,array(":uniacid" => $_W['uniacid']));
