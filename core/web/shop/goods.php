...
if ($operation == 'post') {
	...
	if (checksubmit('submit')) {
		...
		$data = array(
			...
			'noticetype' => is_array($_GPC['noticetype']) ? implode(',', $_GPC['noticetype']) : '', 'needfollow' => intval($_GPC['needfollow']), 
			...
			'discounts' => is_array($_GPC['discounts']) ? json_encode($_GPC['discounts']) : array(), 'detail_logo' => save_media($_GPC['detail_logo']), 
