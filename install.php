...
CREATE TABLE " .  tablename('yz_coupon') . " (
  ...
  `coupon_method` tinyint(4) NOT NULL,
...
CREATE TABLE " .  tablename('yz_order') . " (
  ...
  `dispatch_type_id` int(11) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS " .  tablename('yz_pay_order_back1') . ";

CREATE TABLE " .  tablename('yz_pay_order_back1') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  `int_order_no` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE " .  tablename('yz_pay_refund_order') . " (
  ...
  `uniacid` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
  `int_order_no` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `out_order_no` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `price` int(11) NOT NULL,
  `type` tinyint(1) NOT NULL,
...
CREATE TABLE " .  tablename('yz_pay_request_data') . " (
  ...
  `third_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
VALUES
	...
	(21, '基础设置', 'setting.shop.index', 'setting.shop.index', '', 1, 1, 'fa-sliders', 20, 0, 1, 1490411291, 1490411291, NULL),
	...
	(40, '会员关系设置', 'user_relation', 'member.member-relation.index', '', 1, 1, 'fa-sliders', 38, 0, 1, 1490683533, 1490683533, NULL),
	...
	(78, '资格申请', 'agent_apply', 'member.member-relation.apply', '', 1, 1, 'fa-sliders', 38, 0, 1, 1491981655, 1491981655, NULL),
	(88, '待收货订单', 'order.list.waitReceive', 'order.list.waitReceive', '', 1, 1, 'fa-circle-o', 28, 3, 1, 1492050693, 1492051034, NULL),
	(89, '已完成订单', 'order.list.completed', 'order.list.completed', '', 1, 1, 'fa-circle-o', 28, 6, 1, 1492050737, 1492247768, NULL),
	(90, '申请协议', 'applyprotocol', 'member.member-relation.applyprotocol', '', 1, 1, 'fa-circle-o', 38, 0, 1, 1492093073, 1492093073, NULL),
	...
	(97, '退换货订单', 'refund', 'order.list.refund', '', 1, 1, 'fa-circle-o', 28, 5, 1, 1492170755, 1492247789, NULL);
