...
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('yz_adv') . " (
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_carrier') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_commission_apply') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_commission_clickcount') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_commission_level') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_commission_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_commission_shop') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `mid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_creditshop_adv') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_creditshop_category') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  `thumb` varchar(255) DEFAULT NULL COMMENT '分类图片',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_creditshop_goods') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_creditshop_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `logno` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_designer') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_designer_menu') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_express') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_feedback') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_goods_comment') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_member_address') . " (
   `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '0',
  `realname` varchar(20) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_member_log') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_member_message_template') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_notice') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_order') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
  `agentid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_order_comment') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_order_goods') . " (
   `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_order_refund') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_perm_log') . " (
   `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_perm_plugin') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_perm_role') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_perm_user') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_plugin') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `displayorder` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_saler') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `storeid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_store') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_sysset') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `sets` text,
  `plugins` text,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_virtual_category') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_virtual_data') . " (
`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS  " . tablename('yz_virtual_type') . " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
...
INSERT INTO " . tablename('yz_plugin') . " (`id`,`displayorder`,`identity`,`name`,`version`,`author`,`status`,`category`) VALUES
...
//pdo_fetchall("UPDATE `" . tablename('qrcode'). "` SET `name` = 'yz_POSTER_QRCODE', `keyword`='yz_POSTER' WHERE `keyword` = 'EWEI_SHOP_POSTER'");

if (!pdo_fieldexists('yz_goods', 'cates')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_goods')." ADD `cates` text;");
}

$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('yz_af_supplier'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_supplier_apply'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
if (!pdo_fieldexists('yz_perm_user', 'banknumber')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_perm_user')." ADD `banknumber` varchar(255) NOT NULL COMMENT '银行卡号';");
}

if (!pdo_fieldexists('yz_perm_user', 'accountname')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_perm_user')." ADD `accountname` varchar(255) NOT NULL COMMENT '开户名';");
}

if (!pdo_fieldexists('yz_perm_user', 'accountbank')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_perm_user')." ADD `accountbank` varchar(255) NOT NULL COMMENT '开户行';");
}

if (!pdo_fieldexists('yz_goods', 'supplier_uid')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_goods')." ADD `supplier_uid` INT NOT NULL COMMENT '供应商ID';");
}

if (!pdo_fieldexists('yz_order', 'supplier_uid')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_order')." ADD `supplier_uid` INT NOT NULL COMMENT '供应商ID';");
}

if (!pdo_fieldexists('yz_order_goods', 'supplier_uid')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_order_goods')." ADD `supplier_uid` INT NOT NULL COMMENT '供应商ID';");
}

if (!pdo_fieldexists('yz_order_goods', 'supplier_apply_status')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_order_goods')." ADD `supplier_apply_status` tinyint(4) NOT NULL COMMENT '1为供应商已提现';");
}

if (!pdo_fieldexists('yz_af_supplier', 'id')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_af_supplier')." ADD PRIMARY KEY (`id`);");
}

if (!pdo_fieldexists('yz_supplier_apply', 'id')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_supplier_apply')." ADD PRIMARY KEY (`id`);");
}

if (!pdo_fieldexists('yz_af_supplier', 'id')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_af_supplier')." MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;");
}

if (!pdo_fieldexists('yz_supplier_apply', 'id')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_supplier_apply')." MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;");
}

if (!pdo_fieldexists('yz_perm_role', 'status1')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_perm_role')." ADD `status1` tinyint(3) NOT NULL COMMENT '1：供应商开启';");
}

if (!pdo_fieldexists('yz_perm_user', 'openid')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_perm_user')." ADD `openid` VARCHAR( 255 ) NOT NULL;");
}
...
if (!pdo_fieldexists('yz_af_supplier', 'status')) {
    pdo_fetchall("ALTER TABLE ".tablename('yz_af_supplier')." ADD `status` TINYINT( 3 ) NOT NULL COMMENT '0申请1驳回2通过' AFTER `productname`;");
}

//todo,这里缺少uniacid，我没加，要测试$_W['uniacid']是否可用
$result = pdo_fetch('select * from ' . tablename('yz_perm_role') . ' where status1=1');
if (empty($result)) {
    $sql = "
INSERT INTO " . tablename('yz_perm_role') . " (`rolename`, `status`, `status1`, `perms`, `deleted`) VALUES
('供应商', 1, 1, 'shop,shop.goods,shop.goods.view,shop.goods.add,shop.goods.edit,shop.goods.delete,order,order.view,order.view.status_1,order.view.status0,order.view.status1,order.view.status2,order.view.status3,order.view.status4,order.view.status5,order.view.status9,order.op,order.op.send,order.op.sendcancel,order.op.verify,order.op.fetch,order.op.close,order.op.refund,order.op.export,order.op.changeprice', 0);";
    ...
    pdo_update('yz_perm_role', $gysdata, array('rolename' => "供应商"));
}
