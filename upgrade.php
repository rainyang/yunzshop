...
if(!pdo_fieldexists('yz_member', 'regtype')) {
    pdo_query("ALTER TABLE ".tablename('yz_member')." ADD    `regtype` tinyint(3) DEFAULT '1';");
}
if(!pdo_fieldexists('yz_member', 'isbindmobile')) {
    pdo_query("ALTER TABLE ".tablename('yz_member')." ADD    `isbindmobile` tinyint(3) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_member', 'isjumpbind')) {
    pdo_query("ALTER TABLE ".tablename('yz_member')." ADD    `isjumpbind` tinyint(3) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_creditshop_log', 'storeid')) {
    pdo_query("ALTER TABLE ".tablename('yz_creditshop_log')." ADD    `storeid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_creditshop_log', 'realname')) {
    pdo_query("ALTER TABLE ".tablename('yz_creditshop_log')." ADD   `realname` varchar(255) DEFAULT '';");
}
if(!pdo_fieldexists('yz_creditshop_log', 'mobile')) {
    pdo_query("ALTER TABLE ".tablename('yz_creditshop_log')." ADD   `mobile` varchar(255) DEFAULT '';");
}
if(!pdo_fieldexists('yz_order', 'ordersn2')) {
    pdo_query("ALTER TABLE ".tablename('yz_order')." ADD    `ordersn2` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_order', 'changeprice')) {
    pdo_query("ALTER TABLE ".tablename('yz_order')." ADD    `changeprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_order', 'changedispatchprice')) {
    pdo_query("ALTER TABLE ".tablename('yz_order')." ADD    `changedispatchprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_order', 'oldprice')) {
    pdo_query("ALTER TABLE ".tablename('yz_order')." ADD    `oldprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_order', 'olddispatchprice')) {
    pdo_query("ALTER TABLE ".tablename('yz_order')." ADD    `olddispatchprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_order', 'isvirtual')) {
    pdo_query("ALTER TABLE ".tablename('yz_order')." ADD   `isvirtual` tinyint(3) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_order_goods', 'changeprice')) {
    pdo_query("ALTER TABLE ".tablename('yz_order_goods')." ADD    `changeprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_order_goods', 'oldprice')) {
    pdo_query("ALTER TABLE ".tablename('yz_order_goods')." ADD    `oldprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_order_goods', 'commissions')) {
    pdo_query("ALTER TABLE ".tablename('yz_order_goods')." ADD    `commissions` text;");
}
if(!pdo_fieldexists('yz_goods', 'ednum')) {
    pdo_query("ALTER TABLE ".tablename('yz_goods')." ADD    `ednum` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_goods', 'edmoney')) {
    pdo_query("ALTER TABLE ".tablename('yz_goods')." ADD     `edmoney` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_goods', 'edareas')) {
    pdo_query("ALTER TABLE ".tablename('yz_goods')." ADD      `edareas` text;");
}
if(!pdo_fieldexists('yz_member', 'fixagentid')) {
    pdo_query("ALTER TABLE ".tablename('yz_member')." ADD      `fixagentid` tinyint(3) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_poster', 'reccouponid')) {
    pdo_query("ALTER TABLE ".tablename('yz_poster')." ADD      `reccouponid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_poster', 'reccouponnum')) {
    pdo_query("ALTER TABLE ".tablename('yz_poster')." ADD        `reccouponnum` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_poster', 'subcouponid')) {
    pdo_query("ALTER TABLE ".tablename('yz_poster')." ADD         `subcouponid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_poster', 'subcouponnum')) {
    pdo_query("ALTER TABLE ".tablename('yz_poster')." ADD         `subcouponnum` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_plugin', 'category')) {
    pdo_query("ALTER TABLE ".tablename('yz_plugin')." ADD         `category` varchar(255) DEFAULT '0';");
}
/**/
if(!pdo_fieldexists('yz_goods', 'deduct2')) {
    pdo_query("ALTER TABLE ".tablename('yz_goods')." ADD         `deduct2` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_order', 'couponid')) {
    pdo_query("ALTER TABLE ".tablename('yz_order')." ADD         `couponid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_order', 'couponprice')) {
    pdo_query("ALTER TABLE ".tablename('yz_order')." ADD         `couponprice` decimal(10,2) DEFAULT '0.00';");
}
if(!pdo_fieldexists('yz_creditshop_goods', 'goodstype')) {
    pdo_query("ALTER TABLE ".tablename('yz_creditshop_goods')." ADD      `goodstype` tinyint(3) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_creditshop_goods', 'couponid')) {
    pdo_query("ALTER TABLE ".tablename('yz_creditshop_goods')." ADD      `couponid` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_member_log', 'gives')) {
    pdo_query("ALTER TABLE ".tablename('yz_member_log')." ADD      `gives` decimal(10,2) DEFAULT NULL;");
}
if(!pdo_fieldexists('yz_commission_level', 'downcount')) {
    pdo_query("ALTER TABLE ".tablename('yz_commission_level')." ADD      `downcount` int(11) DEFAULT '0';");
}
if(!pdo_fieldexists('yz_commission_level', 'ordercount')) {
    pdo_query("ALTER TABLE ".tablename('yz_commission_level')." ADD      `ordercount` int(11) DEFAULT '0';");
}
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_coupon_data'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_coupon_guess'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `couponid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_poster'). " (
   `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_poster_log'). " (
 `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_poster_qr'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_poster_scan'). " (
   `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `posterid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_postera'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `type` tinyint(3) DEFAULT '0' COMMENT '1 首页 2 小店 3 商城 4 自定义',
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_postera_log'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `posterid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS ".tablename('yz_postera_qr'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acid` int(10) unsigned NOT NULL,
  `openid` varchar(100) NOT NULL DEFAULT '',
  `posterid` int(11) DEFAULT '0',
...
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('yz_article'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_article_category'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_article_log'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_article_report'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_article_share'). " (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS " . tablename('yz_article_sys'). " (
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO " . tablename('yz_plugin'). " (`id`, `displayorder`, `identity`, `name`, `version`, `author`, `status`) VALUES
(12, 12, 'article', '文章营销', '1.0', '官方', 1);";
pdo_query($sql);

pdo_query("UPDATE " . tablename('yz_plugin') . " SET `name` = '芸众分销' WHERE `identity` = 'commission'");
pdo_query("UPDATE " . tablename('qrcode') . " SET `name` = 'yz_POSTER_QRCODE', `keyword`='yz_POSTER' WHERE `keyword` = 'EWEI_SHOP_POSTER'");

pdo_query("ALTER TABLE  ".tablename('yz_member')." CHANGE  `pwd`  `pwd` VARCHAR( 100 ) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;");

if(!pdo_fieldexists('yz_goods', 'cates')) {
    pdo_query("ALTER TABLE ".tablename('yz_goods')." ADD     `cates` text;");
}

$info = pdo_fetch('select * from ' . tablename('yz_plugin') . ' where identity= "exhelper"  order by id desc limit 1');

if(!$info){
    $sql = "INSERT INTO " . tablename('yz_plugin'). " (`displayorder`, `identity`, `name`, `version`, `author`, `status`, `category`) VALUES(0, 'exhelper', '快递助手', '1.0', '官方', 1, 'tool');";
    pdo_query($sql);
}

$info = pdo_fetch('select * from ' . tablename('yz_plugin') . ' where identity= "yunpay"  order by id desc limit 1');

if(!$info){
    $sql = "INSERT INTO " . tablename('yz_plugin'). " (`displayorder`, `identity`, `name`, `version`, `author`, `status`, `category`) VALUES(0, 'yunpay', '云支付', '1.0', '云支付', 1, 'tool');";
    pdo_query($sql);
}

$info = pdo_fetch('select * from ' . tablename('yz_plugin') . ' where identity= "supplier"  order by id desc limit 1');

if(!$info){
    $sql = "INSERT INTO " . tablename('yz_plugin'). " (`displayorder`, `identity`, `name`, `version`, `author`, `status`, `category`) VALUES(0, 'supplier', '供应商', '1.0', '官方', 1, 'biz');";
    pdo_query($sql);
}
